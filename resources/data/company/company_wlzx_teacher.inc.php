...
$config["connection_mode"]=array(
                                    "s"=>array("table_name"=>"stock_company_wlzx_teacher","way"=>"main")
                                );
$config["field"]=array(
                        "s"=>array(
                                //基本字段
                                ...
                                array("name"=>"teacher_id","db_field"=>"teacher_id","format"=>""),
...
$config["condition"]=array(
                            "s"=>array(
                                ...
                                array("name"=>"teacher_id","field"=>"teacher_id","exist"=>"assign","type"=>"="), 
                            )
                       );
$config["sort"]=array(
    //时间排序
